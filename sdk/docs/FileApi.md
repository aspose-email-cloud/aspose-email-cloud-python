...
```python
FileApi.copy_file(
    cakePrefix_copy_file_request_cakeCodePostProcessor(
        src_path, 
        dest_path, 
        src_storage_name=src_storage_name, 
        dest_storage_name=dest_storage_name, 
...
```python
FileApi.delete_file(
    cakePrefix_delete_file_request_cakeCodePostProcessor(
        path, 
        storage_name=storage_name, 
        version_id=version_id))
```
...
FileApi.download_file(
    cakePrefix_download_file_request_cakeCodePostProcessor(
        path, 
        storage_name=storage_name, 
        version_id=version_id))
```
...
```python
FileApi.move_file(
    cakePrefix_move_file_request_cakeCodePostProcessor(
        src_path, 
        dest_path, 
        src_storage_name=src_storage_name, 
        dest_storage_name=dest_storage_name, 
...
```python
FileApi.upload_file(
    cakePrefix_upload_file_request_cakeCodePostProcessor(
        path, 
        file, 
        storage_name=storage_name))
```
