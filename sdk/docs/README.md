...
*EmailApi* | [**convert_calendar_dto_to_mapi_model_async**](EmailApi.md#convert_calendar_dto_to_mapi_model_async) | **PUT** /email/CalendarModel/model-as-mapi-model | Convert CalendarDto to MapiCalendarDto             
